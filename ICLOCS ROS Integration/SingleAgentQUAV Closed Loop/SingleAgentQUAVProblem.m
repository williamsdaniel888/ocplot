...
problem.states.x0=[0 0 0 0 5 0];

% Initial conditions for system. Bounds if x0 is free s.t. x0l=< x0 <=x0u
problem.states.x0l=[0 0 0 0 5 0]; 
problem.states.x0u=[0 0 0 0 5 0]; 



% State bounds. xl=< x <=xu
problem.states.xl=[0 -10 0 -10 0 -10];
problem.states.xu=[35 10 0 10 30 10];


% State error bounds
problem.states.xErrorTol=[1e-2 1e-2 1e-2 1e-2 1e-2 1e-2];
...
problem.states.xfl=[30 0 0 0 5 0]; 
problem.states.xfu=[30 0 0 0 5 0];
...
problem.inputs.u0l=[-10 -10 0];
problem.inputs.u0u=[10 10 20]; 
...
problem.constraints.gTol=[1e-04];
...
obs_width_start = 9;
obs_width_end = 10;
c=[obs_height*(0.5*tanh(10*(x1-obs_width_start))-0.5*tanh(10*(x1-obs_width_end)))-z];
